...
const paperclass = {
  ...
  variant: {
    a4: {
      ...
      landscape: "w-[297mm] h-[210mm] p-[10mm] page-break-after print:w-[297mm] print:h-[210mm] print:p-[10mm]",
    },
    a5: {
...
function Paper({ children, className, variant = "scroll", orientation = "portrait", countable = true, ...props }: PaperProps) {
