...
import type { FormRef } from "@/component";

export default function FormRefExample() {
  ...
  return (
    <Form onSubmit={handleSubmit} ref={formRef} className="space-y-4 max-w-md">
      ...
      >
        {(field) => (
          <Slider {...field} defaultValue={5} min={0} max={20} step={1} />
        )}
      </Form.Field>
