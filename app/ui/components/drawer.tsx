...
export function DrawerWrapper({
  ...
  return (
    <div
      {...props}
      className={cn(
        "fixed transition-transform duration-300 ease-out flex rounded-xl shadow-elevated max-h-full max-w-full min-w-1/4 min-h-1/3 bg-background text-foreground",
